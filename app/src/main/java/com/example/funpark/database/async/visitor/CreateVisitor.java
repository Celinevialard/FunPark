...
/***
 * Permet de créer un visiteur en background
 */
public class CreateVisitor extends AsyncTask<VisitorEntity, Void, Void> {

    private Application application;
    private OnAsyncEventListener callback;
    private Exception exception;

    public CreateVisitor(Application application, OnAsyncEventListener callback) {
